...
$user_email = mysqli_real_escape_string($db_connect, htmlspecialchars(trim($_POST['user_email'])));

$query = mysqli_query($db_connect, "SELECT * FROM `users` WHERE user_email = '$user_email'");
