...
$username = mysqli_real_escape_string($db_connect, htmlspecialchars($_POST['username']));
$user_email = mysqli_real_escape_string($db_connect, htmlspecialchars($_POST['user_email']));

//IF EMAIL IS VALID
if (filter_var($user_email, FILTER_VALIDATE_EMAIL)) {  

// CHECK IF EMAIL IS ALREADY REGISTERED
$check_email = mysqli_query($db_connect, "SELECT `user_email` FROM `users` WHERE user_email = '$user_email'");
...
$insert_user = mysqli_query($db_connect, "INSERT INTO `users` (username, user_email, user_password) VALUES ('$username', '$user_email', '$user_hash_password')");
