...
$get_user_data = mysqli_query($db_connect, "SELECT * FROM `users` WHERE user_email = '$user_email'");
...
<body>
    ...
    <div class="container">
        <h1>
            ...
            <a style="float: right; text-decoration: none; color: black;" href="logout.php">Logout</a>
        </h1>
    </div>
    <div class="">
        <img src="images/enggal-mukti-M_rP0MPjDIc-unsplash.jpg" alt="" width="100%">
    </div>
    <div class="footer">
        <footer id="footer"> <!-- Start of footer content-->
            <div class="row">
                ...
                <!-- Copyright-->
                <h4 style="text-align: center;"><b> &copy; Copyright 2022 Food's Sake</b></h4>
            </div>
        </footer>
    </div>
</body>
